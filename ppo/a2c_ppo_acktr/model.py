...
class Policy(nn.Module):
    ...
    def forward(self, inputs, rnn_hxs, masks, extras):
        if extras is None:
            ...
            return self.base(inputs, rnn_hxs, masks, extras)
...
class Network(NNBase):
    def __init__(self, input_shape, recurrent=False, hidden_size=512,
                 downscaling=1):
        super(Network, self).__init__(recurrent, hidden_size,
                                            256)
        #print(input_shape)
        ...
        self.linear1 = nn.Linear(out_size * 32 + 32, hidden_size)
