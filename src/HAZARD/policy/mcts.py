...
class MCTS:
    ...
    def calculate_score(self, curr_node: mcts_state, child: mcts_state, expr = True):
    ...
    def select_child(self, curr_node: mcts_state, expr = True):
        scores = [
    ...
    def initialize_children(self, curr_node: mcts_state):
    ...
    def expand(self, leaf_node: mcts_state):
    ...
    def rollout(self, leaf_node: mcts_state):
        sum_reward = 0
